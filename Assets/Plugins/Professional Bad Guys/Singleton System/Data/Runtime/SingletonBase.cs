...
namespace SingletonSystem {
	...
	public abstract class SingletonBase : ScriptableObject {
		...
		/// <summary>
		/// Control where this Singleton appears within the Project Settings.
		/// </summary>
		public virtual string GetProjectSettingsPath() {
			...
			return $"Project/Singletons/{niceName}";
		}
		...
		/// <summary>
		/// Used to initially initialize the singleton. Invoked when the game is first started, before any scene is loaded.
		/// </summary>
		...
		/// <summary>
		/// Invoked at the same time as MonoBehaviour.Start().
		/// </summary>
		...
		/// <summary>
		/// Invoked when the SingletonManager is destroyed.
		/// </summary>
		...
		/// <summary>
		/// Invoked at the same time and in the same way as MonoBehaviour.FixedUpdate().
		/// </summary>
		...
		/// <summary>
		/// Invoked at the same time and in the same way as MonoBehaviour.Update().
		/// </summary>
		...
		/// <summary>
		/// Invoked at the same time and in the same way as MonoBehaviour.LateUpdate().
		/// </summary>
		...
		/// <summary>
		/// Invoked if a Unity Scene is Unloaded.
		/// </summary>
		...
		/// <summary>
		/// Invoked if a Unity Scene is Loaded.
		/// </summary>
